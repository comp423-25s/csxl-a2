"""Base schema with correct reservation PK

Revision ID: 81ad65728b64
Revises:
Create Date: 2025-05-02 15:04:49.037871
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_coworking__operating_hours_end"),
        "coworking__operating_hours",
        ["end"],
        unique=False,
    )
    op.create_index(
        op.f("ix_coworking__operating_hours_start"),
        "coworking__operating_hours",
        ["start"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.Column(
            "chat_history", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["office_hours_recurrence_pattern.id"],
        ),
        sa.ForeignKeyConstraint(
            ["room_id"],
            ["public.room.id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "type",
            sa.Enum("CONCEPTUAL_HELP", "ASSIGNMENT_HELP", name="tickettype"),
            nullable=False,
        ),
        sa.Column(
            "state",
            sa.Enum("QUEUED", "CALLED", "CLOSED", "CANCELED", name="ticketstate"),
            nullable=False,
        ),
        sa.Column("created_at", sa.DateTime(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_table("user")
    op.drop_table("role")
    op.drop_index(op.f("ix_public_room_capacity"), table_name="room", schema="public")
    op.drop_table("room", schema="public")
    op.drop_table("organization")
    op.drop_table("office_hours_recurrence_pattern")
    op.drop_index(
        op.f("ix_coworking__operating_hours_start"),
        table_name="coworking__operating_hours",
    )
    op.drop_index(
        op.f("ix_coworking__operating_hours_end"),
        table_name="coworking__operating_hours",
